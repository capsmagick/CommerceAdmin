				...
				<div class="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
					...
					<Card.Root>
						<Card.Header
							class="flex flex-row items-center justify-between space-y-0 pb-2"
						>
							<Card.Title class="text-sm font-medium">Customer Growth</Card.Title>
					...
					<Card.Root>
						<Card.Header
							class="flex flex-row items-center justify-between space-y-0 pb-2"
						>
							<Card.Title class="text-sm font-medium">Customer Retention Rate</Card.Title>
				...
				<div class="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
					<Card.Root class="col-span-12">
						<Card.Header>
							...
							<Card.Description>You made 265 customers this month.</Card.Description>
						</Card.Header>
						<Card.Content>
							<RecentSales />
						</Card.Content>
