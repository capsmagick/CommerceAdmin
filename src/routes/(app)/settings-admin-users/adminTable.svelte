<script lang="ts">
  ...
  import Actions from "./adminTableActions.svelte";
  import { Button } from "$lib/components/ui/button/index.js";
  import * as DropdownMenu from "$lib/components/ui/dropdown-menu/index.js";
  import { cn } from "$lib/utils.js";
  import { Input } from "$lib/components/ui/input/index.js";
  import DataTableCheckbox from "./adminTableCheckbox.svelte";
  ...
  async function getAdmin() {
    try {
      ...
      if (nextPage) {
        ...
        res = await API.get("/account/manager/");
      }
      next = res.data.next;
  ...
  const hideableCols = ['email', 'mobile_number', 'date_of_birth', 'gender','created_at', 'updated_at', 'created_by', 'updated_by'];
</script>
